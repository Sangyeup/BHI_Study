...
#for num in range(3):
    ...
    for j in range(n):
        ...
        # j -> j+1
        num = abc[abc_idx[s[j]]][abc_idx[s[j+1]]]
        arr[num, j, j+1] += 1
    ...
    for k in range(2,n):
        for l in range(n-k):
            ...
            # a
            #if num == 0:
                arr[0, l, r] += arr[2, l, i]*arr[0, i+1, r]
                arr[0, l, r] += arr[0, l, i]*arr[2, i+1, r]
                arr[0, l, r] += arr[1, l, i]*arr[2, i+1, r]

            # b
            #elif num == 1:  
                arr[1, l, r] += arr[0, l, i]*arr[0, i+1, r]
                arr[1, l, r] += arr[0, l, i]*arr[1, i+1, r]
                arr[1, l, r] += arr[1, l, i]*arr[1, i+1, r]

            # c
            #elif num == 2:
                arr[2, l, r] += arr[1, l, i]*arr[0, i+1, r]
                arr[2, l, r] += arr[2, l, i]*arr[1, i+1, r]
                arr[2, l, r] += arr[2, l, i]*arr[2, i+1, r]
